...
perfmeasures1 <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/perfmeasures1.xlsx"))

# performance measures for the joint on true non-zeros only
fullperfmeas1_nonzero <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim1pf_nonzerosonly.xlsx"))

# performance measures for the joint on true non-zeros and 95% neighbors
fullperfmeas1_neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim1pf_95neighbors.xlsx"))

# performance measures for the joint on true non-zeros and 90% neighbors
fullperfmeas1_90neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim1pf_90neighbors.xlsx"))

# performance measures for the joint on true non-zeros and 85% neighbors
fullperfmeas1_85neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim1pf_85neighbors.xlsx"))
```
...
# performance measures for the marginal estimates
perfmeasures2 <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/perfmeasures2.xlsx"))

# performance measures for the joint on true non-zeros only
fullperfmeas2_nonzero <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim2pf_nonzerosonly.xlsx"))

# performance measures for the joint on true non-zeros and 95% neighbors
fullperfmeas2_neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim2pf_95neighbors.xlsx"))

# performance measures for the joint on true non-zeros and 90% neighbors
fullperfmeas2_90neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim2pf_90neighbors.xlsx"))

# performance measures for the joint on true non-zeros and 85% neighbors
fullperfmeas2_85neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim2pf_85neighbors.xlsx"))
```
...
# performance measures for the marginal estimates
perfmeasures3 <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/perfmeasures3.xlsx"))

# performance measures for the joint on true non-zeros only
fullperfmeas3_nonzero <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim3pf_nonzerosonly.xlsx"))

# performance measures for the joint on the true non-zeros and 95% neighbors
fullperfmeas3_neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim3pf_95neighbors.xlsx"))

# performance measures for the joint on true non-zeros and 90% neighbors
fullperfmeas3_90neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim3pf_90neighbors.xlsx"))

# performance measures for the joint on true non-zeros and 85% neighbors
fullperfmeas3_85neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim3pf_85neighbors.xlsx"))
```
...
# performance measures for the marginal estimates
perfmeasures4 <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/perfmeasures4.xlsx"))

# performance measures for the joint on the true non-zeros only
fullperfmeas4_nonzero <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim4pf_nonzerosonly.xlsx"))

# performance measures for the joint on the true non-zeros and 95% neighbors
fullperfmeas4_neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim4pf_95neighbors.xlsx"))

# performance measures for the joint on true non-zeros and 90% neighbors
fullperfmeas4_90neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim4pf_90neighbors.xlsx"))

# performance measures for the joint on true non-zeros and 85% neighbors
fullperfmeas4_85neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim4pf_85neighbors.xlsx"))
```
...
perfmeasures5 <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim5_marg_pf.xlsx"))

# performance measures for joint on true non-zeros only
fullperfmeas5_nonzero <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim5_joint_nonzero.xlsx"))

# performance measures for joint on true non-zeros and 95% neighbors
fullperfmeas5_neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim5_joint_nonzeroneighbors.xlsx"))

# performance measures for joint on true non-zeros and 90% neighbors
fullperfmeas5_90neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim5_joint_nonzero90neighbors.xlsx"))

# performance measures for joint on true non-zeros and 85% neighbors
fullperfmeas5_85neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim5_joint_nonzero85neighbors.xlsx"))
```
...
# performance measures for marginal estimates, both free parameters
perfmeasures6 <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim6_marg_pf.xlsx"))

# performance measures for joint on true non-zeros only
fullperfmeas6_nonzero <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim6_joint_nonzero.xlsx"))

# performance measures for joint on true non-zeros and 95% neighbors
fullperfmeas6_neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim6_joint_nonzeroneighbors.xlsx"))

# performance measures for joint on true non-zeros and 90% neighbors
fullperfmeas6_90neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim6_joint_nonzero90neighbors.xlsx"))

# performance measures for joint on true non-zeros and 85% neighbors
fullperfmeas6_85neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim6_joint_nonzero85neighbors.xlsx"))
```
...
# performance measures for marginal estimates, both free parameters
perfmeasures7 <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim7_marg_pf.xlsx"))

# performance measures for joint on true non-zeros only
fullperfmeas7_nonzero <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim7_joint_nonzero.xlsx"))

# performance measures for joint on true non-zeros and 95% neighbors
fullperfmeas7_neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim7_joint_nonzeroneighbors.xlsx"))

# performance measures for joint on true non-zeros and 90% neighbors
fullperfmeas7_90neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim7_joint_nonzero90neighbors.xlsx"))

# performance measures for joint on true non-zeros and 85% neighbors
fullperfmeas7_85neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim7_joint_nonzero85neighbors.xlsx"))
```
...
# performance measures for marginal estimates, both free parameters
perfmeasures8 <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim8_marg_pf.xlsx"))

# performance measures for joint on true non-zeros only
fullperfmeas8_nonzero <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim8_joint_nonzero.xlsx"))

# performance measures for joint on true non-zeros and 95% neighbors
fullperfmeas8_neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim8_joint_nonzeroneighbors.xlsx"))

# performance measures for joint on true non-zeros and 90% neighbors
fullperfmeas8_90neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim8_joint_nonzero90neighbors.xlsx"))

# performance measures for joint on true non-zeros and 85% neighbors
fullperfmeas8_85neighbors <- as.matrix(readxl::read_xlsx("C:/Users/gbean/Documents/MCCL REU files/excel sheets/sim8_joint_nonzero85neighbors.xlsx"))
```
...
```{r}
ggplot(data = three_data, mapping = aes(color = parameter)) +
  geom_point(mapping = aes(x = site, y = bias)) +
  geom_hline(yintercept = 0) +
